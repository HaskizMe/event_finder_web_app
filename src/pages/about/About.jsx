                ...
                <div style={{margin: 'auto', marginBottom: '200px', maxWidth: '1800px'}}>
                    ...
                    <div className="section">
                        ...
                        <div className="section-content" style={{ flex: 3 }}>
                            <h2 style={{margin: 0, color: colors.red}}>Discover Events Near You</h2>
                    ...
                    <div className="section">
                        <div className="section-content" style={{ flex: 3 }}>
                                <h2 style={{margin: 0, color: colors.red}}>Host and Manage Events with Ease</h2>
                    ...
                    <div className="section">
                        ...
                        <div className="section-content" style={{ flex: 3 }}>
                            <h2 style={{margin: 0, color: colors.red}}>Interactive and Intuitive Features</h2>
